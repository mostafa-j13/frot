...
class Date
{
    ...
    public function __construct($time, $format=self::tyGregorian)
    {
        switch ($format)
        {
            case self::tyGregorian:
            ...
            case self::tyUNIX:
                ...
                break;
            case self::tyJalali:
                $this->time = $this->makeFromJalali($time);
                break;
        }
    }
     ...
     * @return Date
     */
    public function endOfMonth($type=self::tyJalali)
    {
        $g_days_in_month = array(31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31);
        $j_days_in_month = array(31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 29);
        $mm = $j_days_in_month[intval($this->format('m')) - 1];
        $str = $this->format("Y-m-") . $mm . ' 23:59:59';
        return new self($str, self::tyJalali);
    }
    ...
    public function toMySQL($str='Y-m-d H:i:s')
    {
...
function Convertnumber2english($srting)
{
    ...
    {
        if (substr($srting, $sub, 2) == _JDF_Num0
            )$stringtemp.="0";
        elseif (substr($srting, $sub, 2) == _JDF_Num1
            )$stringtemp.="1";
        elseif (substr($srting, $sub, 2) == _JDF_Num2
            )$stringtemp.="2";
        elseif (substr($srting, $sub, 2) == _JDF_Num3
            )$stringtemp.="3";
        elseif (substr($srting, $sub, 2) == _JDF_Num4
            )$stringtemp.="4";
        elseif (substr($srting, $sub, 2) == _JDF_Num5
            )$stringtemp.="5";
        elseif (substr($srting, $sub, 2) == _JDF_Num6
            )$stringtemp.="6";
        elseif (substr($srting, $sub, 2) == _JDF_Num7
            )$stringtemp.="7";
        elseif (substr($srting, $sub, 2) == _JDF_Num8
            )$stringtemp.="8";
        elseif (substr($srting, $sub, 2) == _JDF_Num9
            )$stringtemp.="9";
        else
        {
...
//
//    <a href="http://www.gnu.org/copyleft/gpl.html" tar="_blank">http://www.gnu.org/copyleft/gpl.html</a>
//
