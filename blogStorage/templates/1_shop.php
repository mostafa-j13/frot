<?php if( !defined( '__IN_LOADTEMPLATE' ) )
    die( 'illigal access' ); ?>
...
<html>
    <head>
        ...
        <style>
            ...
            .main-item, .frotel-item
            {
                width: 100%;
                float: right;
            }

            .main-item h1, .frotel-item h1
            {
            ...
            .item-show-box .main-box .pic a img
            {
                height: 120px;
                width: 140px;
                border: none;
            ...
            .item-show-box .footer .add-card
            {
                background: transparent url('../ui/images/add-card.png') right center no-repeat;
                padding: 10px 34px 0 0;
                height: 32px;
                display: inline-block;
            }
            .item-show-box .footer .add-card span
            {
                color: #006699;
                padding: 4px 0 0 0;
                display: block;
            ...
            {
                float: right;
                background: transparent url('../ui/images/remove.png') no-repeat center center;
                display: block;
                width: 24px;
                height: 24px;
            }
            ...
            <div class ="Center">
                <div class="Container">
                    ...
                    <div style="height:100%">
                        <div class="Content">
                            <div class="main-item">
                                <h1>کالا های فروشگاه</h1>
                                <?php foreach( $tmp->Item as $iterator ): ?>
                                    <?php echo $iterator->item ?>
<?php endforeach; ?>
                            </div>
                            <div class="frotel-item">
                                <h1>کالاهای مشارکتی</h1>
                                <?php foreach( $tmp->FrotelItem as $iterator ): ?>
                                    <?php echo $iterator->item ?>
<?php endforeach; ?>
                            </div>
                        </div>
...
<?php endif; ?>
                            ...
                            <div style="width:100%;border: 1px solid #d9dee1;">
                                ...
                                <div style="padding-top:3px;padding-right:3px"  >
                                    <a href="<?php echo $tmp->ShopUrl; ?>">صفحه نخست</a><br>
